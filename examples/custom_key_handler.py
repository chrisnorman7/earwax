...
This script shows you how you can bypass Earwax, and directly lever the power
of the Pyglet event system in your own games.

As you can see from the below code, it's not exactly the most intuitive code
