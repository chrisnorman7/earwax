...
class BoxLevel(Level, EventDispatcher):
    ...
    * :meth:`~earwax.BoxLevel.turn`
    ...
    :ivar ~earwax.BoxLevel.external_sound_manager: The sound manager to use to
        play sounds that are not generated by the player.
    ...
    def connect_reverb(
        ...
        if self.external_sound_manager is not None:
            self.external_sound_manager.context.config_route(
                self.external_sound_manager.source, reverb
            )
    ...
    def disconnect_reverb(self) -> None:
        ...
        if self.external_sound_manager is not None:
            self.external_sound_manager.context.remove_route(
                self.external_sound_manager.source, self.reverb
            )
        self.reverb = None
